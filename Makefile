...
AVRDUDE2_PORT = /dev/cu.KeySerial1  # programmer connected to serial device
...
AVRDUDE2_FLAGS = -p $(MCU) -P $(AVRDUDE2_PORT) -c $(AVRDUDE2_PROGRAMMER)
AVRDUDE2_FLAGS += $(AVRDUDE_NO_VERIFY)
AVRDUDE2_FLAGS += $(AVRDUDE_VERBOSE)
AVRDUDE2_FLAGS += $(AVRDUDE_ERASE_COUNTER)
